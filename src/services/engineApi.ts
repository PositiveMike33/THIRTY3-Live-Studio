...
class LocalEngineStore {
  ...
  public getMilestone(): FinancialMilestone {
    ...
    return {
      ...
      items: [
        {
          id: 'item-declic-birth',
          label: 'Acte de naissance officiel DEClic! (Directeur de l’état civil Québec)',
          amountCAD: infraTargetA,
          fundedCAD: Math.round(infraFundedA * 100) / 100,
          allocation: 'Formalité administrative d’identité légale & vérification officielle',
          status: infraFundedA >= infraTargetA ? 'funded' : 'pending',
          description: 'Obtention en ligne accélérée de l’acte de naissance via le portail DEClic! du Directeur de l’état civil du Québec (45,75 $ CAD).',
        },
        {
          id: 'item-heredite-notariee',
          ...
          allocation: 'Clôture juridique successorale & minute notariale authentique',
          status: infraFundedB >= infraTargetB ? 'funded' : 'partially_funded',
          description: 'Rédaction et scellement notarié de la déclaration d’hérédité officielle par l’étude de Me Léopold Lincà, notaire à Montréal (465,00 $ CAD).',
        },
      ],
